...
class RiddleRepository(
    ...
    private fun parseRiddlesFromText(): List<Riddle> {
        return listOf(
            ...
            // 🆕 新增谐音梗系列
            Riddle(question = "什么样的人死后还会出现？", answer = "电影里的人", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "一只蜜蜂叮在挂历上猜一成语", answer = "风和日丽", category = "谐音梗", difficulty = 3),
            Riddle(question = "两只蜜蜂打架猜一歌名", answer = "为蜂狂", category = "谐音梗", difficulty = 3),
            Riddle(question = "谁是兽中之王？", answer = "动物园园长", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "什么动物天天熬夜？", answer = "熊猫（黑眼圈）", category = "脑筋急转弯", difficulty = 1),
            Riddle(question = "一颗豆子掉到地上会变成什么？", answer = "豆芽", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "一只蚂蚁从北京到南京只用一秒，为什么？", answer = "在地图上爬", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "什么布剪不断？", answer = "瀑布", category = "谐音梗", difficulty = 2),
            Riddle(question = "什么伞撑开后比合上还小？", answer = "降落伞", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "什么东西天气越热它爬得越高？", answer = "温度计", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "什么东西不大不小，能装下整个世界？", answer = "眼睛", category = "脑筋急转弯", difficulty = 3),
            Riddle(question = "一加一在什么情况下不等于二？", answer = "算错的时候", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "为什么北极熊不吃企鹅？", answer = "南北极不在一起", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "为什么企鹅的肚子是白色的？", answer = "短手洗不到背", category = "脑筋急转弯", difficulty = 3),
            Riddle(question = "螃蟹为什么横着走？", answer = "因为它牛", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "怎么让鸭蛋变鹅蛋？", answer = "鸭蛋变馊（鹅）", category = "谐音梗", difficulty = 3),
            Riddle(question = "什么鸡没有翅膀？", answer = "田鸡", category = "脑筋急转弯", difficulty = 1),
            Riddle(question = "什么蛋打不烂、煮不熟、吃不得？", answer = "考鸭蛋", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "什么人始终不敢洗澡？", answer = "泥人", category = "脑筋急转弯", difficulty = 1),
            Riddle(question = "什么样的桶子永远装不满？", answer = "废水桶", category = "脑筋急转弯", difficulty = 2),

            // 🆕 新增成语谜
            Riddle(question = "稻草人，打一成语", answer = "不堪一击", category = "成语", difficulty = 3),
            Riddle(question = "千里通电话，打一成语", answer = "遥相呼应", category = "成语", difficulty = 3),
            Riddle(question = "蜜饯黄连，打一成语", answer = "同甘共苦", category = "成语", difficulty = 3),
            Riddle(question = "婚丧事，打一成语", answer = "悲喜交加", category = "成语", difficulty = 3),
            Riddle(question = "盲人骑瞎马，打一成语", answer = "横冲直撞", category = "成语", difficulty = 3),
            Riddle(question = "举重比赛，打一成语", answer = "斤斤计较", category = "成语", difficulty = 3),
            Riddle(question = "枪弹上膛，打一成语", answer = "一触即发", category = "成语", difficulty = 3),
            Riddle(question = "脱粒机，打一成语", answer = "吞吞吐吐", category = "成语", difficulty = 3),
            Riddle(question = "全面开荒，打一成语", answer = "不留余地", category = "成语", difficulty = 3),
            Riddle(question = "灯谜，打一成语", answer = "一语道破", category = "成语", difficulty = 2),
            Riddle(question = "百米赛跑，打一成语", answer = "争先恐后", category = "成语", difficulty = 2),
            Riddle(question = "蜜蜂酿蜜，打一成语", answer = "酿苦成甜", category = "成语", difficulty = 4),
            Riddle(question = "出口成章，打一成语", answer = "一语千金", category = "成语", difficulty = 4),
            Riddle(question = "举一反三，打一成语", answer = "触类旁通", category = "成语", difficulty = 3),
            Riddle(question = "下雪天没穿鞋，打一成语", answer = "光踪大雪", category = "成语", difficulty = 4),
            Riddle(question = "不长五谷，打一成语", answer = "颗粒无收", category = "成语", difficulty = 3),
            Riddle(question = "聋子的耳朵，打一成语", answer = "形同虚设", category = "成语", difficulty = 3),
            Riddle(question = "无底洞，打一成语", answer = "深不可测", category = "成语", difficulty = 2),
            Riddle(question = "孙猴子翻筋斗，打一成语", answer = "一步登天", category = "成语", difficulty = 2),
            Riddle(question = "一千张纸，打一成语", answer = "厚积薄发", category = "成语", difficulty = 3),

            // 🆕 新增脑筋急转弯
            Riddle(question = "什么时候太阳会从西边出来？", answer = "发誓的时候", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "拳击冠军很容易被谁击倒？", answer = "瞌睡虫", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "时钟什么时候不会走？", answer = "时钟本来就不会走", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "什么书谁也没见过？", answer = "天书", category = "脑筋急转弯", difficulty = 1),
            Riddle(question = "怎样让一只鸭子不会叫？", answer = "让它变烤鸭", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "什么车没有轮子？", answer = "象棋里的车", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "一头牛和五只羊在一起打牌，谁会赢？", answer = "牛（牛皮）", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "什么海没有水？", answer = "脑海", category = "脑筋急转弯", difficulty = 1),
            Riddle(question = "什么花一年四季都开？", answer = "塑料花", category = "脑筋急转弯", difficulty = 1),
            Riddle(question = "什么样的水不能喝？", answer = "薪水", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "为什么蝙蝠白天不出来？", answer = "怕被太阳晒黑", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "你早上醒来第一件事是做什么？", answer = "睁开眼睛", category = "脑筋急转弯", difficulty = 1),
            Riddle(question = "什么东西经常会来，但却从来没真正来过？", answer = "明天", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "什么样的路不能走？", answer = "电路", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "什么蛋中看不中吃？", answer = "脸蛋", category = "脑筋急转弯", difficulty = 1),
            Riddle(question = "什么剑是透明的？", answer = "看不见", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "黑头发有什么好处？", answer = "不怕晒黑", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "什么样的速度最快？", answer = "光速", category = "脑筋急转弯", difficulty = 1),
            Riddle(question = "猫见了什么会逃跑？", answer = "老鼠药", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "什么样的人骑马最危险？", answer = "马戏团演员", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "为什么大象的鼻子那么长？", answer = "因为它会撒谎", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "什么东西比乌鸦更讨厌？", answer = "乌鸦嘴", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "一只青蛙掉进50米深的井里要怎样才能跳出来？", answer = "从井里游出来", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "怎样使麻雀安静下来？", answer = "压它一下（鸦雀无声）", category = "成语", difficulty = 3),
            Riddle(question = "在一次考试中，张三和李四的答案一字不差，可监考老师认为他们没作弊，为什么？", answer = "都是空白", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "什么样的强者千万别当？", answer = "强盗", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "情人节不开心的人是谁？", answer = "光棍", category = "脑筋急转弯", difficulty = 1),
            Riddle(question = "情人最伤心的是？", answer = "见光死", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "什么人最喜欢日光浴？", answer = "晒被人", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "什么时候我们会甘心熄灭自己的生命之火？", answer = "睡觉的时候", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "兔子的耳朵为什么那么长？", answer = "妈妈生的", category = "脑筋急转弯", difficulty = 1),
            Riddle(question = "如果你有一双翅膀你会做什么？", answer = "找医生治病", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "厕所里放鞭炮，打一成语", answer = "愤（粪）发图（土）强", category = "成语", difficulty = 4),
            Riddle(question = "见人就笑的是什么花？", answer = "迎春花", category = "谐音梗", difficulty = 2),
            Riddle(question = "什么东西愈生气，它就愈大？", answer = "脾气", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "黑人为什么喜欢吃白色巧克力？", answer = "怕咬到自己的手", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "什么东西看不到却闻得到摸得着？", answer = "屁", category = "脑筋急转弯", difficulty = 1),
            Riddle(question = "用什么方法可以让人开口说话？", answer = "打哈欠", category = "脑筋急转弯", difficulty = 2),
            Riddle(question = "什么事天不知地知，你不知我知？", answer = "鞋底破洞", category = "脑筋急转弯", difficulty = 2)
        )
    }
}
